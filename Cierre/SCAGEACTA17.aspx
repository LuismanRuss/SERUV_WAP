<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA17" Codebehind="SCAGEACTA17.aspx.cs" %>
...
<body>
    ...
    <div id="agp_contenido">               
        ...
        <h2>UVCG-XIII-AP-01 Informe de gestión de la dependencia</h2>
        <div id="secCUATRO" class="conSeccion">   
            <label>Período:</label><input type="text" /> 
            <label>Fecha de elaboración:</label><input type="text" />      
