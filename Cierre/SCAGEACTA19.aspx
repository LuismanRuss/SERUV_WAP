<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA19" Codebehind="SCAGEACTA19.aspx.cs" %>
...
<body>
    ...
    <div id="agp_contenido">               
        <h2 class="titulo2">XV. Asuntos Diversos</h2>    
      
        <h2>UVCG-XV-AD-01 Combinación de caja fuerte en sobre cerrado</h2>
        <div id="secCUATRO" class="conSeccion">   
           <%-- <label>Núm. De observaciones:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />        --%>                           
        </div>
        <br />     
          <h2>UVCG-XV-AD-02 Relación de llaves de mobiliario, equipo y oficinas</h2>
        <div id="Div1" class="conSeccion">   
            <label>Cantidad de llaves:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />                                   
        </div>
        <br />     
          <h2>UVCG-XV-AD-03 Relación de sellos oficiales</h2>
        <div id="Div2" class="conSeccion">   
            <label>Cantidad de sellos:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />                                   
        </div>
        <br />            
