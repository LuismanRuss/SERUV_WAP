<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA13" Codebehind="SCAGEACTA13.aspx.cs" %>
...
<body>
    ...
    <div id="agp_contenido">               
        <h2 class="titulo2">IX. Obra pública</h2>    
      
        <h2>UVCG-IX-OP-01 Programa anual de ejecución de obras y mantenimiento</h2>
        <div id="secCUATRO" class="conSeccion">   
            <label>Fojas:</label><input type="text" />                                       
        </div>
        <br />
          <h2>UVCG-IX-OP-02 Relación de obras concluidas</h2>
        <div id="Div1" class="conSeccion">  
         <label>Cantidad de obras:</label><input type="text" />                  
            <label>Fojas:</label><input type="text" />                                       
        </div>
        <br />
          <h2>UVCG-IX-OP-03 Relación de obras en proceso</h2>
