<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA8" Codebehind="SCAGEACTA8.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#txtFechaElab").mask("99-99-9999");
            $('#dFNombram').mask("99-99-9999");
            var idParticipante;
            //   NG.setNact(2, 'Dos', null);

            $('#txtFechaElab').datepicker(vDate);
        ...
        function pTablaI(tab) {
            ...
            htmlTab += '<th scope="col" style="width:10%;" class="no_sort Acen" title="Ordenar">Ejercicio</th>';
            htmlTab += '<th scope="col" style="width:10%;" class="no_sort Acen" title="Ordenar">Período</th>';
...
<body>
    ...
    <div id="agp_contenido">   
        ...
        <h2 class="titulo2">IV. Estados financieros</h2>   
        ...
        <div class="TablaGrid">
         ...
         <div id="titUNO" class="titSeccion" style="margin-top: 1em;">
            ...
            <div class="dLabelA" onclick="fn_accordion('UNO')" id="d_lUNO" title="Colapsar">UVCG-IV-EF-06 Estado analítico del activo</div>
       ...
       <%-- <h2>UVCG-IV-EF-06 Estado analítico del activo</h2>--%>
        <div id="secUNO" class="conSeccion">           
           ...
           <div id="titDOS" class="titSeccion">
            ...
            <div class="dLabelA" onclick="fn_accordion('DOS')" id="d_lDOS" title="Expandir">UVCG-IV-EF-07 Informes sobre pasivos contingentes</div>
        ...
        <%--<h2>UVCG-IV-EF-07 Informes sobre pasivos contingentes</h2>--%>
        <div id="secDOS" class="conSeccion">           
            <label>Periodo:</label><input type="text" />
            <label>Fecha elaboración:</label><input type="text" id="txtFechaElab" />
            <label>Fojas:</label><input type="text"/>                                            
        </div>
             <div id="titTRES" class="titSeccion">
            <div id="Tit_TRES" class="dActionA" onclick="fn_accordion('TRES')" title="Expandir">-</div>
            <div class="dLabelA" onclick="fn_accordion('TRES')" id="d_lTRES" title="Expandir">UVCG-IV-EF-08 Notas a los estados financieros</div>
        ...
        <%--<h2>UVCG-IV-EF-08 Notas a los estados financieros</h2>--%>
