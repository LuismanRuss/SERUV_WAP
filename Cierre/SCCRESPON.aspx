<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCCRESPON" Codebehind="SCCRESPON.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //Función que identifica el navegador utilizado
        function navegador() {
            if (safari)
        ...
        // Envia el id de la notificación a la BD para que actualice el indicador leido de ese registro
        function MensajeLeido() { 
            ...
            $.ajax({
                url: "../Cierre/SCCRESPON.aspx/fMensajeLeido",
                data: actionData,
                dataType: "json",
                type: "POST",
        ...
        //función utilizada para guardar la notificación que se va a enviar
        function Enviar() {
            var strDatos = "";
            ...
            if (fValidaTextArea()) {
                ...
                //alert("antes ajax");
                $.ajax({
                    url: "../Cierre/SCCRESPON.aspx/EnviarRespuesta",
                    data: actionData,
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
        ...
        //Función utiliada para evitar caracteres no validos
        function jsTrim(sString) {
            return sString.replace(/^\s+|\s+$/g, "");
        }

        //Función qu valida que el textarea contenga información acerca de la respuesta  
...
<body>
    <form id="SCCRESPON" runat="server">
