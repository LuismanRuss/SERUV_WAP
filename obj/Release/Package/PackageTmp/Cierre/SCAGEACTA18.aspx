<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA18" Codebehind="SCAGEACTA18.aspx.cs" %>
...
<body>
    ...
    <div id="agp_contenido">               
        <h2 class="titulo2">XIII. Informe de gestión</h2>    
      
        <h2>UVCG-XIV-OP-01 Relación de observaciones y/o recomendaciones de la Contraloría General</h2>
        <div id="secCUATRO" class="conSeccion">   
            <label>Núm. De observaciones:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />                                   
        </div>
        <br />     
          <h2>UVCG-XIV-OP-02 Relación de compromisos pendientes derivados de procesos de entrega-recepción</h2>
        <div id="Div1" class="conSeccion">   
            <label>Núm. de compromisos:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />                                   
        </div>
        <br />     
          <h2>UVCG-XIV-OP-03 Relación de observaciones y/o sugerencias de los auditores externos</h2>
        <div id="Div2" class="conSeccion">   
            <label>Núm. de observaciones:</label><input type="text" />            
            <label>Fojas:</label><input type="text" />                                   
        </div>
        <br />     
          <h2>UVCG-XIV-OP-04 Relación de observaciones y/o recomendaciones de los órganos superiores de fiscalización</h2>
