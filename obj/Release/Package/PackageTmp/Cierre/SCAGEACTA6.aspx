<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA6" Codebehind="SCAGEACTA6.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var Sort_SCAGEACTA6 = new Array(2);  /* Indicación de la ordenación por default del grid */
        Sort_SCAGEACTA6[0] = [{ "bSortable": false }, null, null, null];
        Sort_SCAGEACTA6[1] = [[1, "asc"]];
...
//            }
        ...
        function fGetApartados() {
            ...
            $.ajax(
                {
                    url: "SCAGEACTA6.aspx/Acta_Apartados",
                    data: actionData,
                    dataType: "json",
                    type: "POST",
        ...
        function Pinta_Grid(strCadena) {
            ...
            NG.Var[NG.Nact].oTable = $('#grid').dataTable({
                ...
                "bLengthChange": true,
                "aaSorting": Sort_SCAGEACTA6[1],
                "aoColumns": Sort_SCAGEACTA6[0]
            });
        }
        ...
        function pTablaI(tab) {
            ...
            htmlTab += '<th scope="col" style="width:10%;" class="no_sort Acen" title="Ordenar">Origen</th>';
...
<body>
    ...
    <div id="agp_contenido">               
        <label class="titulo2">I. ORGANIZACIÓN Y MARCO NORMATIVO DE ACTUACIÓN</label>
        <div class="TablaGrid">
