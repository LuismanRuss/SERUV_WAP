<%@ Page Language="C#" AutoEventWireup="true" Inherits="Cierre_SCAGEACTA14" Codebehind="SCAGEACTA14.aspx.cs" %>
...
<body>
   <form id="SCAGEACTA3" runat="server">
    <div id="agp_contenido">               
        ...
        <h2>UVCG-X-LP-01 Inventario de bibliografía</h2>
        <div id="secCUATRO" class="conSeccion">   
            <label>Cantidad de volumenes:</label><input type="text" /> 
            <label>Fojas:</label><input type="text" />                                      
        </div>
        <br />
          <h2>UVCG-X-LP-02 Relación de vales vencidos por préstamos de libros</h2>
        <div id="Div1" class="conSeccion">  
         <label>Cantidad de vales:</label><input type="text" />                  
            <label>Fojas:</label><input type="text" />                                       
        </div>        
