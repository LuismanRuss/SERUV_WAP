<%@ Page Language="C#" AutoEventWireup="true" Inherits="Registro_SCAENVIO" Codebehind="SCAENVIO.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Cancelar() {
            loading.ini();
            urls(1, "../Registro/SCACARINF.aspx");
            NG.setNact(0, 'Cero');
            //urls(1, "SCACARINF.aspx");
        }
        ...
        function BuscaUsuarios() {
            ...
            dTxt += '<iframe id="SCCUSUARI" src="../Registro/SCCUSUARI.aspx' + '" frameBorder="0" style="width:99%;border-style:none;border-width:0px;height:99%;"></iframe>';
            dTxt += '</div>';
            $('#SCAENVIO').append(dTxt);
            $("#dComent").dialog({
                autoOpen: true,
                height: 600,
                width: 1100,
        ...
        function Enviar() {
            ...
            if (correos == '' || recomendacion == null || recomendacion == '' || asunto == null || asunto == '') {
                ...
                var actionData = "{'correos': '" + correos +
                                ...
                                "'}";
                $.ajax({
                    url: "../Registro/SCAENVIO.aspx/EnviarCorreo",
                    data: actionData,
                    dataType: "json",
                    type: "POST",
