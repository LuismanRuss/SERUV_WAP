<%@ Page Language="C#" AutoEventWireup="true" Inherits="Informacion_SILINFORM" Codebehind="SILINFORM.aspx.cs" %>
...
<%--    <script src="../scripts/jquery-1.5.1.min.js" type="text/javascript"></script> --%>   
    ...
    <script type="text/javascript">
        ...
        pageUrl[1] = "SILMANUAL.aspx"; /***********DECLARACIÓN DE LOS TABULADORES QUE SE VAN A MOSTRAR CON LA LIGA A LA PÁGINA CON INFORMACIÓN ***********/        


        function loadTab(id) {
            if (pageUrl[id].length > 0) {
                $(".navcontainer a").css({ background: "#ffffff" }); /*******ESTILO FONDO DE LOS TABS SELECCIONADOS**********/
                $("#tab" + id).css({ background: "#f5f5f5" }); /*******ESTILO FONDO DE LOS TABS NO SELECCIONADOS**********/
                loading.iniSmall();
                //alert(id);
                $.ajax({
                    url: pageUrl[id],
...
<div id="page">   
    <div id="ContGral">
        ...
        <div class="navcontainer">
		    <ul>
			    <%--<li><a id="tab1" href="#">Manuales</a></li>--%>    		    
	        </ul>
        </div>       
