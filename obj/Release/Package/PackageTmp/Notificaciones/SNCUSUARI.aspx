<%@ Page Language="C#" AutoEventWireup="true" Inherits="Notificaciones_SNCUSUARI" Codebehind="SNCUSUARI.aspx.cs" %>
...
<script type="text/javascript">
    ...
    function Ajax() {
        ...
        //console.log("conso");
        $.ajax({
            url: "../Notificaciones/SNCUSUARI.aspx/Pinta_Grid",
            // data: actionData,
            dataType: "json",
            type: "POST",
...
//        return nombreUsuario;
    ...
    function fRegresarDatos(arregloSeleccionadas) {
        ...
        var actionData = "{'sSeleccionadas': '" + arregloSeleccionadas +
                               "'}";
        $.ajax({
            url: "../Notificaciones/SNCUSUARI.aspx/fIncluirDest",
            data: actionData,
